	          ...
	          <?php echo Html::img('assets/img/logo.png',array('class' => 'logo')) ?>
	           ...
	           <ul class="nav pull-right"> 	
	            ...
	            <li class="dropdown">
	              ...
	              <a data-toggle="dropdown" class="dropdown-toggle" href="#"><?php echo Html::img('assets/img/gear.png',array('class' => 'menu-icon'))?></a>
	              
	              <ul class="dropdown-menu">
	               	<?php if(Auth::member(1)): ?>
					<li class="<?php echo Uri::segment(2) == '' ? '' : '' ?>">
						<?php echo Html::anchor('users/jeepneyroute', 'Jeepney Routes') ?>
					</li>

					<li class="<?php echo Uri::segment(2) == '' ? '' : '' ?>">
						<?php echo Html::anchor('users/tricycleroute', 'Tricycle Routes') ?>
					</li>

					<li class="<?php echo Uri::segment(2) == '' ? '' : '' ?>">
						<?php echo Html::anchor('users/landmarks', 'Landmarks') ?>
					</li>
					<?php endif; ?> <!--if member is 1!-->
					...
					<li class="<?php echo Uri::segment(2) == '' ? '' : '' ?>">
						<?php echo Html::anchor('admin/jeepneyroute', 'Jeepney Routes') ?>
					</li>

					<li class="<?php echo Uri::segment(2) == '' ? '' : '' ?>">
						<?php echo Html::anchor('admin/tricycleroute', 'Tricycle Routes') ?>
					</li>

					<li class="<?php echo Uri::segment(2) == '' ? '' : '' ?>">
						<?php echo Html::anchor('admin/landmarks', 'Landmarks') ?>
					</li>

					<li class="<?php echo Uri::segment(2) == '' ? '' : '' ?>">
						<?php echo Html::anchor('admin/landmarkcategories', 'Landmark Categories') ?>
					</li>

					<li class="<?php echo Uri::segment(2) == '' ? '' : '' ?>">
						<?php echo Html::anchor('admin/comments', 'Comments') ?>
					</li>
