...
<?php foreach ($landmarks as $landmark): ?>		<tr>
			...
			<td style="padding-bottom:20px;">
				<div>
				<p style="font-size: 20px; border-bottom:1px solid #B3B3B3; padding-top:5px; width:500px;"><b><?php echo Html::anchor('landmarks/view/'.$landmark->slug, $landmark->placename) ; ?></b></p>
				<p style="margin-top:-20px; width:500px;"><i><?php echo $landmark->description; ?></i></p>
				</div>	
					<div class="span4">
						<div><?php echo Html::anchor('landmarks/view/'.$landmark->slug, Html::img('uploads/landmarks/thumb/'.$landmark->fileurl,array('class' => 'image')));?></div>
					</div>
			</td>
