...
<div class="row">
	<div class="span4" id="c-img">
		<div class="t-name"><p>Write a comment</p></div>
 			<br>
			<div class="inner-cont">
			<?php echo Form::open('landmarks/comment/'.$landmark->slug) ?>
			

			   <label for="name">Name:</label>
			   <div class="input"><?php echo Form::input('name',' ',array('class' => 'span4')); ?></div>
			
			 
			
			   <label for="email">Email:</label>
			   <div class="input"><?php echo Form::input('email',' ',array('class' => 'span4')); ?></div>
...
<div class="row">
	<div class="span4" id="c-img">
		...
		<div class = "inner-cont">
		<?php echo Form::open('landmarks/vote/'.$landmark->slug) ?>
...
<?php echo Html::anchor('landmarks', 'Back'); ?>